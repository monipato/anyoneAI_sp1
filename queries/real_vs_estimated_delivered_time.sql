...
SELECT
    ...
    AVG(CASE WHEN STRFTIME('%Y', o.order_purchase_timestamp) = '2016' 
        ...
        - julianday(( o.order_purchase_timestamp)) END) AS Year2016_real_time,
    AVG(CASE WHEN STRFTIME('%Y', o.order_purchase_timestamp) = '2017' 
        THEN julianday( o.order_delivered_customer_date)
        - julianday(( o.order_purchase_timestamp)) END) AS Year2017_real_time,
    AVG(CASE WHEN STRFTIME('%Y', o.order_purchase_timestamp) = '2018' 
        THEN julianday( o.order_delivered_customer_date)
        - julianday(( o.order_purchase_timestamp)) END) AS Year2018_real_time,
    AVG(CASE WHEN STRFTIME('%Y', o.order_purchase_timestamp) = '2016' 
        THEN julianday( o.order_estimated_delivery_date)
        - julianday(( o.order_purchase_timestamp)) END) AS Year2016_estimated_time,
    AVG(CASE WHEN STRFTIME('%Y', o.order_purchase_timestamp) = '2017' 
        THEN julianday( o.order_estimated_delivery_date)
        - julianday((o.order_purchase_timestamp)) END) AS Year2017_estimated_time,
    AVG(CASE WHEN STRFTIME('%Y', o.order_purchase_timestamp) = '2018' 
        THEN julianday( o.order_estimated_delivery_date)
        - julianday((o.order_purchase_timestamp)) END) AS Year2018_estimated_time
FROM olist_orders o
WHERE           
